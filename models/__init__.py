...
To add a custom model class called 'dummy',
you need to add a file called 'dummy_model.py' and define a subclass DummyModel inherited from BaseModel.
...
In the function <__init__>, you need to define four lists:
    ...
    -- self.optimizers (optimizer list):    define and initialize optimizers.
                                            ...
                                            See cycle_gan_model.py for a usage.
