...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        self.save_dir = os.path.join(opt.checkpoints_dir, opt.name, "model")  # save all the checkpoints to save_dir
        self.schedulers = []
    ...
    def set_input(self, model_input):
        ...
        Parameters:
            model_input (dict): includes the data itself and its metadata information.
        """
        pass
    ...
    def get_current_losses(self):
        """ Return training losses / errors. train.py will print out these errors, and save them to a file """
    ...
    def load_networks(self, epoch):
        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                # # Delete the metadata of the state_dict
